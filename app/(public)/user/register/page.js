...
export default function RegisterForm() {
  ...
  if (user) {
    return null; // Jeśli użytkownik jest zalogowany, formularz rejestracji nie jest renderowany
  }
  ...
  const onSubmit = (data) => {
    ...
    createUserWithEmailAndPassword(auth, data.email, data.password)
      ...
      .catch((error) => {
        setRegisterError(error.message); // Obsługa błędów rejestracji
        console.error(error);
      });
  };
